...
export function Details() {
  ...
  function handleOrderClose() {
    if (!solution) {
      return Alert.alert("Solicitação", "Preencha uma solução para encerrar a solicitação.");
    }
  ...
  return (
    <VStack flex={1} bg="gray.700">
      ...
      {order.status === "open" && (
        <Button title="Encerrar Solicitação" m={5} onPress={handleOrderClose} isLoading={isLoading} />
      )}
    </VStack>
  );
}
